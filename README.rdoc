...
EndNote and RefWorks have the very useful "Find and Replace" funtion, which can help you batch modify your records to clean your data. In EndNote, go to "Edit", "Find and Replace". In RefWorks, click on the "Global Edit" icon, and expand the "Replace" section in the popup box.
