...
The directory is a self contained system. You can drop it on to any web server, and point your browser to the +index.html+ file. If you are using your Rails application to view it, start your Rails server, and point your browser to:
